...
config = {
    "apiKey": "AIzaSyA3cL_NkEt1JSm3YLaTjA1caj9uRfoXLr4",
    'authDomain': "medical-plant-2dc3f.firebaseapp.com",
    'databaseURL': "https://herbal-ayush-default-rtdb.firebaseio.com",
    'projectId': "medical-plant-2dc3f",
    'storageBucket': "medical-plant-2dc3f.firebasestorage.app",
    'messagingSenderId': "725524490778",
    'appId': "1:725524490778:web:0a3af0c22bef9611f1bfa3",
    'measurementId': "G-NE6GQX5E4D"
}
...
model_species = load_model('crop.h5')
model_species.load_weights('crop_weights.h5')
...
@app.route('/signup')
def signup():
    return render_template('sign_up page.html')
